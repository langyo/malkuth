...
from _harness import Proc, bin_path, free_port, line_request, wait_port  # noqa: E402
...
def test_cli_proxy_basic() -> None:
    ...
    try:
        ...
        assert line_request(pub, "ping") == "pong", "ping did not return pong"
        h = line_request(pub, "health")
